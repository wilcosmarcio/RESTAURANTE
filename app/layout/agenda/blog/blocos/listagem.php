          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" >
            ...
            <div class="member" style="width: 100%;">
                ...
                <a href="<?php echo $resultado_dados['certificado'].'://'.$host.'/blog/conteudo/'.$linhas_artigos['url'];?>">
                    <div style="background-image: url('https://<?php echo $host;?>/uploads/<?php echo $linhas_artigos['file'];?>'); background-size: 100%; height: 190px; background-repeat: no-repeat;"></div>
                </a>
              
              <a href="<?php echo $resultado_dados['certificado'].'://'.$host.'/produtos/conteudo/'.$linhas_artigos['url'];?>">
              <div style="height: 55px;">
                  <span style="color: grey;"><?php echo date('d/m/Y H:i', strtotime($linhas_artigos['data'].''.$linhas_artigos['hora']));?></span>
                <div style="height: 45px;">
                    <h5 style="font-size: 17px;"><?php echo $linhas_artigos['categoria'];?></h5>
                </div>
