...
<body>
    ...
    <br>
    <div class="container">
        <a href="https://<?php echo $host;?>/user/usuarios/novo" class="btn btn-primary rounded-pill py-3 px-5" >Novo cadastro</a>
        <br><br>
        <?php include('app/layout/'.$resultado_templete_i['templete'].'/user/usuarios/blocos/listagem.php');?>
    </div>
