...
<div class="row">
    ...
    <div class="col-lg-6">
        <div style="border: 1px solid #4db6f9; padding: 15px;">
            <h4 style="color: #4db6f9;"><?php echo $resultado_plan['plano'];?></h4>
            Plano mensal (Teste por 7 dias) 
            <br>
            <h4>R$ <?php echo $resultado_plan['valor'];?> /Mês</h4>
            <a href="https://<?php echo $host;?>/#planos" target="_BLANK">Detalhes dos planos</a>
            <hr>
            <span style="color: grey; font-size: 15px;">O primeiro pagamento será somente após 7 dias! Os pagamento são  processados via PIX e a compensação geralmente leva poucos segundos.</span>
            <center>
    ...
    <div class="col-lg-6">
        ...
        <form action="" method="POST">
                <div class="row g-3">
                    ...
                    <input type="hidden" name="plano" value="<?php echo $resultado_plan['id'];?>">
                    <div class="col-md-12">
                        <div class="form-floating">
