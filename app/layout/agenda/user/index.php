...
<body>
   ...
   <br>
    ...
    <div class="container">
        <?php if($validacao == 'ok'){ ?>
            <?php include('app/layout/'.$resultado_templete_i['templete'].'/user/blocos/dados.loja.php');?>
        <?php } else { ?>
            <?php
            if($url[1] == ''){
                include('app/layout/'.$resultado_templete_i['templete'].'/user/blocos/forms.php');
            } else {
                include('app/layout/'.$resultado_templete_i['templete'].'/user/blocos/formPlano.php');
            }
            ?>
        <?php  } ?>
    </div>
