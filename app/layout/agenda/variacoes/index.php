...
<?php $object_item->EditarVariacao_Nome();?>
    <br>
    <div class="container">
        <a href="https://<?php echo $host;?>/variacoes/novo" class="btn btn-primary rounded-pill py-3 px-5" >Novo cadastro</a>
        <br><br>
        <?php $object_item->ListarVariacoes();?>
