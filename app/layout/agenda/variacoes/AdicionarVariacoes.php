...
<?php $object_item->AddVariacaoFilho();?>
    <br>
    <div class="container">
        <form action="" method="POST">
            <div class="row">
                <h4>Novo cadastro em: <b style="color: #4db6f9;"><?php echo $tituloVariacao;?></b></h4>
                <div class="col-lg-6">
                ...
                <div class="col-lg-3">
                    <input type="submit" class="btn btn-primary rounded-pill py-3 px-5" name="btn_AddVariacaoFilho" value="Enviar cadastro">
                </div>
            </div>
        </form>
<?php $object_item->EditarVariacao_Item();?>
        <br><br>
<?php $object_item->ListarVariacaoFilho();?>
