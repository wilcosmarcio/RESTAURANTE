...
<body>
   ...
   <br>
    ...
    <br>
    <div class="container">
        <?php $object_item->AdicionarAdicional();?>
        <form action="" method="POST">
            <div class="row">
                ...
                <div class="col-4">
                    <div class="form-floating">
                        <input type="text" class="form-control" name="preco_venda" placeholder="Preço venda" onKeyPress="return(myfunction(this,'','.',event))" required>
                        <label for="subject">Preço venda</label>
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-floating">
                        <input type="text" class="form-control" name="preco_custo" placeholder="Preço custo" onKeyPress="return(myfunction(this,'','.',event))" required>
                        <label for="subject">Preço custo</label>
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-floating">
                        <input type="text" class="form-control" name="estoque" placeholder="estoque" required>
                ...
                <div class="col-4">
                    <div class="form-floating">
                        <button class="btn btn-primary rounded-pill py-3 px-5" name="btn_AddAdicional" type="submit">Cadastrar adicional</button>
                    </div>
                </div>
