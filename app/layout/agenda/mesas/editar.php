...
<body>
   ...
   <br>
    ...
    <br>
    <div class="container">
        <?php $object_item->EditarMesa();?>
        <form action="" method="POST">
            <div class="row">
                <div class="col-12">
                    <div class="form-floating">
                        <input type="text" class="form-control" name="titulo" placeholder="Título" value="<?php echo $titulomesas;?>" required>
                ...
                <div class="col-4">
                    <div class="form-floating">
                        <button class="btn btn-primary rounded-pill py-3 px-5" name="btn_EditarMesa" type="submit">Atualizar mesa</button>
                    </div>
                </div>
