...
<body>
   ...
   <br>
    ...
    <br>
    <div class="container">
        <?php $object_item->EditarCategoria();?>
        <form action="" class="form-horizontal" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-12">
                    <div class="form-floating">
                        <input type="text" class="form-control" name="titulo" placeholder="Título" value="<?php echo $tituloCategoria;?>" required>
                ...
                <div class="col-4">
                    <div class="form-floating">
                        <div class="btn-group">
                            <input type="radio" class="btn-check" name="destaque" id="option1" value="2" autocomplete="off" <?php echo $destaqueCheckAtivo;?> />
                            <label class="btn btn-success" for="option1">Ativo</label>
                                            
                            <input type="radio" class="btn-check" name="destaque" id="option2" value="1" autocomplete="off" <?php echo $destaqueCheck;?> />
                ...
                <div class="col-4">
                    <div class="form-floating">
                        <button class="btn btn-primary rounded-pill py-3 px-5" name="btn_EditarCategoria" type="submit">Atualizar categoria</button>
                    </div>
                </div>
