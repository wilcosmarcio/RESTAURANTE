...
<body>
   ...
   <br>
    ...
    <br>
    <div class="container">
        <a href="https://<?php echo $host;?>/categorias/novo" class="btn btn-primary rounded-pill py-3 px-5" >Novo cadastro</a>
        <br><br>
        <div id="msg"></div>
        <b style="float: right;">Mude a order da listagem clicando em cima e arrastando</b>
        <?php $object_item->ListarCategorias();?>
	...
	$(document).ready(function () {
        $(function () {
            $("#lista").sortable({update: function () {
					...
					$.post("https://<?php echo $host;?>/ordercategorias", ordem_atual, function (retorno) {
