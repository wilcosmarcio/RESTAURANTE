<?php
        ...
        $sqlComandaCliente = mysqli_query($conexao,"SELECT * FROM UsersCardapio WHERE id = '".$resultadoComandaInt['user_id']."' ORDER BY 'id'") or die("Erro1");
        $resultadoComandaCliente = mysqli_fetch_assoc($sqlComandaCliente);
...
<div class="container">
    <div style="border-radius: 10px; border: solid grey 1px;">
        ...
        <div style="padding: 5px;">
            ...
            <br>
            Telefone: <b><a href="https://web.whatsapp.com/send/?phone=55<?php echo $resultadoComandaCliente['telefone'];?>" target="_blank"><?php echo $resultadoComandaCliente['telefone'];?></a></b>
            <br>
...
<div class="container">
    ...
    foreach ($resultado as $key => $value) {
        ...
        echo '<tr>';
        echo '<td>';
        echo '<b style="font-size: 17px;">'.$resultado_item['titulo'].' </b><br><b style="color: grey;">un.</b> <b>R$ '.number_format($resultado_item['preco_venda'],2,",",".").'</b><br>';
        ...
        echo '<td>R$ '.number_format($subtotal2,2,",",".").'</td>';
        echo '</tr>';
    }
    $desconto       = 0;
...
<?php } ?>
<div class="container">
    <form action="https://<?php echo $host;?>/comandas/update/<?php echo $url[2];?>" method="POST">
        <textarea class="form-control" name="obs" placeholder="Observações do restaurante"><?php echo $resultadoComandaId['obs'];?></textarea>
        <br>
        <input type="submit" class="btn btn-primary" name="BtnObs" value="Salvar">
    </form>
</div>
